...
class Database
{
    ...
    // Private constructor — prevents external instantiation via new Database()
    ...
    public static function getInstance(): PDO
    {
        if (self::$instance === null) {
            ...
            self::$instance = new PDO($dsn, DB_USER, DB_PASS, [
                ...
                PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC,        // Default to associative array fetch mode
